          ...
          style={{
            ...
            <Layout style={{margin:'2rem',border:'solid 1px grey', borderRadius:'10px'}}>
              ...
              <Flex style={{gap:'1rem'}}>
                ...
                <Button  className='green-button'>Column</Button>
              ...
              Locality Wise Summary - 25-05-2024</h6>
              <Table
...
export default LocalityWiseSummery;
