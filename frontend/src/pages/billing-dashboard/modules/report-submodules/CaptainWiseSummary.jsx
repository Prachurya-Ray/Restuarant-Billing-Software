        ...
        <Layout style={{ marginLeft: collapsed ? 80 : 200 }}>
          ...
          style={{
            ...
            <Layout style={{margin:'2rem',border:'solid 1px grey', borderRadius:'10px', padding:'1rem'}}>
                    ...
                    <Flex justify="space-between" style={{padding:'1rem'}}>
                            ...
                            <Flex align="center">
                                ...
                                <Flex >
                                    <span>Exclude Categories from sale :</span>
...
export default CaptainWiseSummery;
