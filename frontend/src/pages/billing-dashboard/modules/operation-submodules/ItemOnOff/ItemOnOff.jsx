           ...
           <Content>
                <div>
                    <div className="d-flex justify-content-between align-items-center p-1" style={{backgroundColor:'#c7c8cc'}}>
                        <div>
                            <span className="pe-3 cursor-pointer" onClick={toggleonlineOrder}>Item On/Off</span>
                            <span className="cursor-pointer" onClick={toggleadvanceOrder}>Addon On/Off</span>
                        </div>
                        <Button  icon={<ArrowLeftOutlined />}>Back</Button>
                    </div>
                    {
                    ...
                    {
                        advanceOrder && <h1>Addon On/Off</h1>
                    }
                </div>
