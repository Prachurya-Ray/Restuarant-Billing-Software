        ...
        <Layout style={{ marginLeft: collapsed ? 80 : 200 }}>
          ...
          <Layout style={{ margin: "2rem", border: "solid 1px grey", borderRadius: "10px", padding:'1rem' }}>
            ...
            <Flex gap='middle' className="p-3">
              <Link to='printerlisting'>
              <Card
                style={{
                width: 300,
                }}
            >
                <p>Multiple Printer Setting</p>
            </Card>
              </Link>
            

            <Link to='preferedconfig'>
            <Card
                style={{
                width: 300,
                }}
            >
                <p>Bill/KOT Prefered Configuration</p>
            </Card>
            </Link>
